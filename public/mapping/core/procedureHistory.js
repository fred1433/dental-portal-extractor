...
function normalizeFrequency(procedure) {
...
function normalizeLimitations(procedure) {
...
export function extractProcedureHistory(raw) {
...
export function mapProcedureHistory(procedures) {
    const map = {};
...
//# sourceMappingURL=procedureHistory.js.map