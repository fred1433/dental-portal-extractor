...
export type VerificationFieldKey = 'Practice Name' | 'Provider Name' | 'Appointment Date' | 'Patient Name' | 'Patient DOB' | 'Subscriber/Policy Holder Name' | 'Subscriber/Policy Holder DOB' | 'Member ID' | 'SSN' | 'Insurance Name' | 'Group Name / #' | 'COB Type' | 'Phone Number' | 'Payor ID' | 'Coordination of Benefits' | 'Other Insurance on File?' | 'Claims Mailing Address' | 'Effective Date' | 'Annual Maximum' | 'Family Deductible' | 'Benefit Year' | 'Remaining Maximum' | 'Lifetime Deductible' | 'Coverage Start Date' | 'Coverage End Date' | 'Individual Deductible' | 'Deductible Applies To' | 'Co-Pay' | 'Network Participation' | 'If OON, Paid As' | 'Assignment of Benefits Accepted?' | 'Fee Schedule Used' | 'Preventive / Diagnostic (% Covered)' | 'Basic Services (% Covered)' | 'Major Services (% Covered)' | 'Missing Tooth Clause' | 'Preventive Wait Period' | 'Basic Wait Period' | 'Major Wait Period';
